...
public struct WhereBuilder {
    ...
    public static func buildEither<Content>(first: Content) -> Content where Content: WhereSQLExpressible {
        first
    }

    public static func buildEither<Content>(second: Content) -> Content where Content: WhereSQLExpressible {
        second
    }
}
